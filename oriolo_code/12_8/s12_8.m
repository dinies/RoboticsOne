...
% of "Robotics: Modelling, Planning and Control", 3rd Ed., Springer, 2009
% by Siciliano, Sciavicco, Villani, Oriolo
% 
% RRT-based motion planning for a unicycle robot
 
% G. Oriolo
% DIS, Univ. di Roma La Sapienza", Italy
% December 2008
...
threshold = 0.02; % distance threshold;  the algorithm stops when the distance between a new configuration qNew of the tree and qGoal is smaller than threshold 
probBiasedExpansion = 0.6; % the probability of a goal-biased expansion, i.e. the probability that qRand is forced to qGoal
